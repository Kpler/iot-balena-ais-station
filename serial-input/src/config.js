const config = {
    ...
    app: {
        ...
        isRawModeEnabled: process.env.IS_RAW_MODE_ENABLED && process.env.IS_RAW_MODE_ENABLED === 'true',
        output: {
            sendMode: process.env.SERIAL_OUTPUT_SEND_MODE || 'udp',
            host: process.env.SERIAL_OUTPUT_HOST || '0.0.0.0',
